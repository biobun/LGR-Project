    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5 image_section">
                ...
                <p class="text-center pb-4" style="color: #668ea7">Login to your account</p>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 py-1">
                                    <a href="{{url('facebook')}}" class="btn btn-facebook btn-block">
                                        <span class="fab fa-facebook-f"></span>
                                    &nbsp;&nbsp;Facebook</a>
                                </div>
                                <div class="col-md-6 py-1">
                                    <a href="{{ url('google') }}" class="btn btn-google btn-block">
